...
function Room({
  ...
  return (
    <div
      aria-hidden
      className={`absolute inset-0 overflow-hidden bg-[#040a15] pointer-events-none ${className}`}
    >
      <div
        ...
        style={{
          ...
          background:
            "linear-gradient(to bottom, rgba(14,28,48,1) 0%, rgba(4,10,21,1) 100%)",
        }}
      />
      <div
        className="absolute inset-0"
        style={{
          ...
          background:
            "linear-gradient(to bottom, rgba(2,6,12,1) 0%, rgba(4,10,21,0.85) 100%)",
        }}
      />
      <div
        className="absolute inset-0"
        style={{
          ...
          background:
            "linear-gradient(to right, rgba(4,10,21,1) 0%, rgba(8,16,30,1) 70%, rgba(14,28,48,1) 100%)",
        }}
      />
      <div
        className="absolute inset-0"
        style={{
          ...
          background:
            "linear-gradient(to left, rgba(4,10,21,1) 0%, rgba(8,16,30,1) 70%, rgba(14,28,48,1) 100%)",
        }}
      />
      <div
        className="absolute inset-0"
        style={{
          ...
          background:
            "linear-gradient(to top, rgba(10,20,38,1) 0%, rgba(4,10,21,1) 100%)",
        }}
      />
      ...
      >
        {[35, 50, 65].map((pos, i) => (
          <div key={i} className="absolute flex flex-col items-center" style={{ left: `${pos}%`, top: '3%', transform: 'translate(-50%, -4px)' }}>
            ...
            <div className="relative mt-[6px] w-[54px] h-[64px] flex justify-center" style={{ perspective: '200px' }}>
      ...
      <div 
        className="absolute pointer-events-none w-full h-[80px]"
        style={{ zIndex: 29, top: '4%', left: 0, background: 'linear-gradient(to bottom, rgba(0,0,0,0.6), transparent)', filter: 'blur(16px)' }}
      />
      <div 
        className="absolute inset-0 pointer-events-none"
        style={{ 
...
export const VolumetricStudio = ({ 
  ...
  // Trigger flicker only when section scrolls into view
  React.useEffect(() => {
  ...
  // Run flicker animation once triggered
  React.useEffect(() => {
    if (!hasTriggered) return;
    let mounted = true;
  ...
  return (
    <section ref={sectionRef} className={cn("relative w-full h-full min-h-[600px] bg-black overflow-hidden font-sans", className)}>
      <Room
        lightsOn={lightsOn}
        intensity={1}
        lightColor="230,240,255"
